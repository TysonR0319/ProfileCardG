    ...
    variables.country == null ? "Country" : variables.country
          ...
          <ul class="${variables.socialMediaPosition}">
            <li><a href="${variables.twitter ||
              "https://twitter.com/alesanchezr"}"><i class="fab fa-twitter"></i></a></li>
            <li><a href="${variables.github ||
              "https://github.com/alesanchezr"}"><i class="fab fa-github"></i></a></li>
            <li><a href="${variables.linkedin ||
              "https://linkedin.com/alesanchezr"}"><i class="fab fa-linkedin"></i></a><//li>
            <li><a href="${variables.instagram ||
              "https://instagram.com/alesanchezr"}"><i class="fab fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
